...
import { FormValidation, validateContent, validateForm, VALIDATION_RULES } from '../../utils/validation/validation'
  ...
  useAutoSave(newIdea, 'idea_form_draft', {
    ...
    onSave: (data) => {
      if (data.title || data.description) {
        saveDraft({
          ...data,
          category: data.category_id, // Convert category_id to category for draft compatibility
          timestamp: Date.now()
        })
      }
    }
